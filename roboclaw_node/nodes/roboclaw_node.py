...
class EncoderOdom:
    ...
    def update_publish(self, enc_left, enc_right,headerID, childID,i):
        ...
        if abs(enc_left - self.last_enc_left) > 20000:
            ...
            self.publish_odom(self.cur_x, self.cur_y, self.cur_theta, vel_x, vel_theta, headerID, childID, i)

    def publish_odom(self, cur_x, cur_y, cur_theta, vx, vth, headerID, childID, i):
