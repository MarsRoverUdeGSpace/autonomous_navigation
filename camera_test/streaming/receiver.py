...
def main():
    ...
    while key != 113:  # for 'q' key
        ...
        if err == sl.ERROR_CODE.SUCCESS:
            ...
            #Fullscreen
            cv2.namedWindow("Camera Remote Control", cv2.WINDOW_NORMAL)
            cv2.setWindowProperty("Camera Remote Control", cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ip_address', type=valid_ip_or_hostname, help='IP address or hostname of the sender. Should be in format a.b.c.d:p or hostname:p',default = '192.168.55.1:30000', required=False)
