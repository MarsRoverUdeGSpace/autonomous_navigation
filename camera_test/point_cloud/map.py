...
def create_reference_frame():
    ...
    t.header.frame_id = 'map'  # Cambia 'map' al marco de referencia que desees como base

    # Establecer el marco de referencia objetivo
    t.child_frame_id = 'base_link'  # Cambia 'base_link' al marco de referencia que deseas crear
